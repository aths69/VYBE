...
# must be registered before sessions_router's parameterized
# "/api/sessions/{session_id}", or FastAPI would match "history" as a
# session_id and never reach the history endpoint.
